...
An end-to-end MLOps project for detecting fraudulent credit card transactions using machine learning. This repository demonstrates the complete machine learning lifecycle—from data ingestion to production-ready deployment—following industry-standard MLOps .
